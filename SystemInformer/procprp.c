    ...
    case WM_COMMAND:
        {
            if (GET_WM_COMMAND_HWND(wParam, lParam) == propSheetContext->OptionsButtonWindowHandle)
            {
                ...
                if (propContext->ProcessItem->ProcessId == SYSTEM_PROCESS_ID)
                {
                    ...
                    PhInsertEMenuItem(menuItem, PhCreateEMenuItem(0, ID_PROCESS_DUMP_FULL, L"完全(&F)...", NULL, NULL), ULONG_MAX);
                ...
                menuItem = PhCreateEMenuItem(0, ID_PROCESS_MISCELLANEOUS, L"其他(&M)", NULL, NULL);
                ...
                PhInsertEMenuItem(menuItem, PhCreateEMenuItem(0, ID_MISCELLANEOUS_ECOMODE, L"效能模式", NULL, NULL), ULONG_MAX);
                PhInsertEMenuItem(menuItem, PhCreateEMenuItem(0, ID_MISCELLANEOUS_EXECUTIONREQUIRED, L"执行要求", NULL, NULL), ULONG_MAX);
                PhInsertEMenuItem(menuItem, PhCreateEMenuItem(0, ID_MISCELLANEOUS_GDIHANDLES, L"GDI 对象句柄(&H)...", NULL, NULL), ULONG_MAX);
                ...
                PhInsertEMenuItem(menuItem, PhCreateEMenuItem(0, ID_MISCELLANEOUS_RUNAS, L"以特定用户身份运行(&R)...", NULL, NULL), ULONG_MAX);
    ...
    )
{
    ...
    {
        PhSetStringSetting(SETTING_PROC_PROP_PAGE, L"线程");
    }
