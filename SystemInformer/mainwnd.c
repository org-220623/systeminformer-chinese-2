    ...
    )
{
    ...
    PhInsertEMenuItem(ViewMenu, PhCreateEMenuSeparator(), ULONG_MAX);
    PhInsertEMenuItem(ViewMenu, PhCreateEMenuItem(0, ID_VIEW_ALWAYSONTOP, L"始终置顶(&A)", NULL, NULL), ULONG_MAX);
    ...
    )
{
    ...
    {
        PhInsertEMenuItem(menuItem, PhCreateEMenuItem(0, ID_NOTIFICATIONS_ARRIVEDDEVICES, L"已就绪设备(&A)", NULL, NULL), ULONG_MAX);
