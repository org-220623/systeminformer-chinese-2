    ...
    )
{
    ...
    PhListView_AddGroup(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, L"内存");
    PhListView_AddGroup(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_IO, L"I/O");
    PhListView_AddGroup(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_OTHER, L"其他");
    ...
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_CPUUSER, L"CPU (用户)", (PVOID)PH_PROCESS_STATISTICS_INDEX_CPUUSER);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_CPUKERNEL, L"CPU (内核)", (PVOID)PH_PROCESS_STATISTICS_INDEX_CPUKERNEL);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_CPUAVERAGE, L"CPU (均值)", (PVOID)PH_PROCESS_STATISTICS_INDEX_CPUAVERAGE);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_CPURELATIVE, L"CPU (相对)", (PVOID)PH_PROCESS_STATISTICS_INDEX_CPURELATIVE);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_CYCLES, L"周期", (PVOID)PH_PROCESS_STATISTICS_INDEX_CYCLES);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_CYCLESDELTA, L"周期增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_CYCLESDELTA);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_CONTEXTSWITCHES, L"上下文切换", (PVOID)PH_PROCESS_STATISTICS_INDEX_CONTEXTSWITCHES);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_CONTEXTSWITCHESDELTA, L"上下文切换增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_CONTEXTSWITCHESDELTA);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_KERNELTIME, L"内核时间", (PVOID)PH_PROCESS_STATISTICS_INDEX_KERNELTIME);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_KERNELDELTA, L"内核时间增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_KERNELDELTA);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_USERTIME, L"用户时间", (PVOID)PH_PROCESS_STATISTICS_INDEX_USERTIME);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_USERDELTA, L"用户时间增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_USERDELTA);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_TOTALTIME, L"时间总计", (PVOID)PH_PROCESS_STATISTICS_INDEX_TOTALTIME);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_TOTALDELTA, L"时间总计增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_TOTALDELTA);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_CPU, PH_PROCESS_STATISTICS_INDEX_PRIORITY, L"优先级", (PVOID)PH_PROCESS_STATISTICS_INDEX_PRIORITY);

    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PRIVATEBYTES, L"私有字节", (PVOID)PH_PROCESS_STATISTICS_INDEX_PRIVATEBYTES);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PRIVATEBYTESDELTA, L"私有字节增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_PRIVATEBYTESDELTA);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PEAKPRIVATEBYTES, L"私有字节峰值", (PVOID)PH_PROCESS_STATISTICS_INDEX_PEAKPRIVATEBYTES);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_VIRTUALSIZE, L"虚拟大小", (PVOID)PH_PROCESS_STATISTICS_INDEX_VIRTUALSIZE);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PEAKVIRTUALSIZE, L"虚拟大小峰值", (PVOID)PH_PROCESS_STATISTICS_INDEX_PEAKVIRTUALSIZE);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PAGEFAULTS, L"页面错误", (PVOID)PH_PROCESS_STATISTICS_INDEX_PAGEFAULTS);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PAGEFAULTSDELTA, L"页面错误增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_PAGEFAULTSDELTA);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_HARDFAULTS, L"硬错误", (PVOID)PH_PROCESS_STATISTICS_INDEX_HARDFAULTS);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_HARDFAULTSDELTA, L"硬错误增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_HARDFAULTSDELTA);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_WORKINGSET, L"工作集", (PVOID)PH_PROCESS_STATISTICS_INDEX_WORKINGSET);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PEAKWORKINGSET, L"工作集峰值", (PVOID)PH_PROCESS_STATISTICS_INDEX_PEAKWORKINGSET);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PRIVATEWS, L"私有工作集", (PVOID)PH_PROCESS_STATISTICS_INDEX_PRIVATEWS);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_SHAREABLEWS, L"可共享工作集", (PVOID)PH_PROCESS_STATISTICS_INDEX_SHAREABLEWS);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_SHAREDWS, L"已共享工作集", (PVOID)PH_PROCESS_STATISTICS_INDEX_SHAREDWS);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PAGEDPOOL, L"分页池字节", (PVOID)PH_PROCESS_STATISTICS_INDEX_PAGEDPOOL);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PEAKPAGEDPOOL, L"分页池字节峰值", (PVOID)PH_PROCESS_STATISTICS_INDEX_PEAKPAGEDPOOL);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_NONPAGED, L"非分页池字节", (PVOID)PH_PROCESS_STATISTICS_INDEX_NONPAGED);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PEAKNONPAGED, L"非分页池字节峰值", (PVOID)PH_PROCESS_STATISTICS_INDEX_PEAKNONPAGED);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_SHAREDCOMMIT, L"已共享提交", (PVOID)PH_PROCESS_STATISTICS_INDEX_SHAREDCOMMIT);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PRIVATECOMMIT, L"私有提交", (PVOID)PH_PROCESS_STATISTICS_INDEX_PRIVATECOMMIT);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PEAKPRIVATECOMMIT, L"私有提交峰值", (PVOID)PH_PROCESS_STATISTICS_INDEX_PEAKPRIVATECOMMIT);
    //PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PRIVATECOMMITLIMIT, L"私有提交限制", (PVOID)PH_PROCESS_STATISTICS_INDEX_PRIVATECOMMITLIMIT);
    //PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_TOTALCOMMITLIMIT, L"提交限制总计", (PVOID)PH_PROCESS_STATISTICS_INDEX_TOTALCOMMITLIMIT);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_MEMORY, PH_PROCESS_STATISTICS_INDEX_PAGEPRIORITY, L"页面优先级", (PVOID)PH_PROCESS_STATISTICS_INDEX_PAGEPRIORITY);

    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_READS, L"读取", (PVOID)PH_PROCESS_STATISTICS_INDEX_READS);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_READSDELTA, L"读取增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_READSDELTA);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_READBYTES, L"读取字节", (PVOID)PH_PROCESS_STATISTICS_INDEX_READBYTES);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_READBYTESDELTA, L"读取字节增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_READBYTESDELTA);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_WRITES, L"写入", (PVOID)PH_PROCESS_STATISTICS_INDEX_WRITES);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_WRITESDELTA, L"写入增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_WRITESDELTA);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_WRITEBYTES, L"写入字节", (PVOID)PH_PROCESS_STATISTICS_INDEX_WRITEBYTES);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_WRITEBYTESDELTA, L"写入字节增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_WRITEBYTESDELTA);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_OTHER, L"其他", (PVOID)PH_PROCESS_STATISTICS_INDEX_OTHER);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_OTHERDELTA, L"其他增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_OTHERDELTA);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_OTHERBYTES, L"其他字节", (PVOID)PH_PROCESS_STATISTICS_INDEX_OTHERBYTES);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_OTHERBYTESDELTA, L"其他字节增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_OTHERBYTESDELTA);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_IOTOTAL, L"总计字节", (PVOID)PH_PROCESS_STATISTICS_INDEX_IOTOTAL);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_IOTOTALDELTA, L"总计字节增量", (PVOID)PH_PROCESS_STATISTICS_INDEX_IOTOTALDELTA);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_IOAVERAGE, L"总计字节 (均值)", (PVOID)PH_PROCESS_STATISTICS_INDEX_IOAVERAGE);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_IO, PH_PROCESS_STATISTICS_INDEX_IOPRIORITY, L"I/O 优先级", (PVOID)PH_PROCESS_STATISTICS_INDEX_IOPRIORITY);

    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_HANDLES, L"句柄", (PVOID)PH_PROCESS_STATISTICS_INDEX_HANDLES);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_PEAKHANDLES, L"句柄峰值", (PVOID)PH_PROCESS_STATISTICS_INDEX_PEAKHANDLES);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_GDIHANDLES, L"GDI 对象句柄", (PVOID)PH_PROCESS_STATISTICS_INDEX_GDIHANDLES);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_PEAKGDIHANDLES, L"GDI 对象句柄峰值", (PVOID)PH_PROCESS_STATISTICS_INDEX_PEAKGDIHANDLES);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_USERHANDLES, L"用户对象句柄", (PVOID)PH_PROCESS_STATISTICS_INDEX_USERHANDLES);
    PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_PEAKUSERHANDLES, L"用户对象句柄峰值", (PVOID)PH_PROCESS_STATISTICS_INDEX_PEAKUSERHANDLES);

    if (WindowsVersion >= WINDOWS_10_RS3)
    {
        PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_RUNNINGTIME, L"运行时间", (PVOID)PH_PROCESS_STATISTICS_INDEX_RUNNINGTIME);
        PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_SUSPENDEDTIME, L"挂起时间", (PVOID)PH_PROCESS_STATISTICS_INDEX_SUSPENDEDTIME);
        PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_HANGCOUNT, L"挂起计数", (PVOID)PH_PROCESS_STATISTICS_INDEX_HANGCOUNT);
        PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_GHOSTCOUNT, L"幽灵计数", (PVOID)PH_PROCESS_STATISTICS_INDEX_GHOSTCOUNT);
        ...
        PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_NETWORKTXRXBYTES, L"网络发送/接收字节", (PVOID)PH_PROCESS_STATISTICS_INDEX_NETWORKTXRXBYTES);
        //PhListView_AddGroupItem(Context->ListViewContext, PH_PROCESS_STATISTICS_CATEGORY_OTHER, PH_PROCESS_STATISTICS_INDEX_MBBTXRXBYTES, L"移动宽带发送/接收字节", NULL);
    }
    ...
    case WM_INITDIALOG:
        {
            ...
            PhListView_AddColumn(statisticsContext->ListViewContext, 0, 0, 0, LVCFMT_LEFT, 135, L"属性");
            PhListView_AddColumn(statisticsContext->ListViewContext, 1, 1, 1, LVCFMT_LEFT, 150, L"值");
            PhListView_AddColumn(statisticsContext->ListViewContext, 2, 2, 2, LVCFMT_LEFT, 150, L"最小");
            PhListView_AddColumn(statisticsContext->ListViewContext, 3, 3, 3, LVCFMT_LEFT, 150, L"最大");
            PhListView_AddColumn(statisticsContext->ListViewContext, 4, 4, 4, LVCFMT_LEFT, 150, L"差值");
