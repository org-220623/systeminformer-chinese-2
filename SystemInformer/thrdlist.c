    ...
    )
{
    ...
    PhAddTreeNewColumn(TreeNewHandle, PH_THREAD_TREELIST_COLUMN_LASTSTATUSCODE, FALSE, L"最后一次状态代码", 50, PH_ALIGN_LEFT, ULONG_MAX, 0);
...
#define PH_OLE_TLS_FLAG(x, n) { TEXT(#x), (x), FALSE, FALSE, (n) }
    static const PH_ACCESS_ENTRY oleTlsflags[] =
    {
        ...
        PH_OLE_TLS_FLAG(OLETLS_IN_ACTIVATION_FILTER, L"位于激活筛选器"),
