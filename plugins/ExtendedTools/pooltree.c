    ...
    )
{
    ...
    PhAddTreeNewColumn(Context->TreeNewHandle, TREE_COLUMN_ITEM_PAGEDFREE, TRUE, L"分页空闲 (总计)", 80, PH_ALIGN_RIGHT, 3, DT_RIGHT);
    ...
    PhAddTreeNewColumn(Context->TreeNewHandle, TREE_COLUMN_ITEM_NONPAGEDFREE, TRUE, L"非分页空闲 (总计)", 80, PH_ALIGN_RIGHT, 7, DT_RIGHT);
    ...
    PhAddTreeNewColumn(Context->TreeNewHandle, TREE_COLUMN_ITEM_ALLOC, FALSE, L"分配 (总计)", 80, PH_ALIGN_RIGHT, 2, DT_RIGHT);
    PhAddTreeNewColumn(Context->TreeNewHandle, TREE_COLUMN_ITEM_FREE, FALSE, L"空闲 (总计)", 80, PH_ALIGN_RIGHT, 3, DT_RIGHT);
    PhAddTreeNewColumn(Context->TreeNewHandle, TREE_COLUMN_ITEM_CURRENT, FALSE, L"当前 (总计)", 80, PH_ALIGN_RIGHT, 4, DT_RIGHT);
    PhAddTreeNewColumn(Context->TreeNewHandle, TREE_COLUMN_ITEM_TOTAL, FALSE, L"字节 (总计)", 80, PH_ALIGN_LEFT, 5, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, TREE_COLUMN_ITEM_PAGEDALLOCDELTA, FALSE, L"分页分配 (增量)", 80, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, TREE_COLUMN_ITEM_PAGEDFREEDELTA, FALSE, L"分页空闲 (增量)", 80, PH_ALIGN_LEFT, ULONG_MAX, 0);
    ...
    PhAddTreeNewColumn(Context->TreeNewHandle, TREE_COLUMN_ITEM_NONPAGEDFREEDELTA, FALSE, L"非分页空闲 (增量)", 80, PH_ALIGN_RIGHT, ULONG_MAX, 0);
    ...
    PhAddTreeNewColumn(Context->TreeNewHandle, TREE_COLUMN_ITEM_ALLOCDELTA, FALSE, L"分配 (增量)", 80, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, TREE_COLUMN_ITEM_FREEDELTA, FALSE, L"空闲 (增量)", 80, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, TREE_COLUMN_ITEM_CURRENTDELTA, FALSE, L"当前 (增量)", 80, PH_ALIGN_LEFT, ULONG_MAX, 0);
    PhAddTreeNewColumn(Context->TreeNewHandle, TREE_COLUMN_ITEM_TOTALDELTA, FALSE, L"字节 (增量)", 80, PH_ALIGN_LEFT, ULONG_MAX, 0);
