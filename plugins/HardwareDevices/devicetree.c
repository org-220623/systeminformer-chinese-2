...
const DEVICE_PROPERTY_TABLE_ENTRY DeviceItemPropertyTable[] =
{
    ...
    { PhDevicePropertyLastArrivalDate, L"最后设备就绪时间", FALSE, 160, 0 },
    { PhDevicePropertyLastRemovalDate, L"最后设备移除时间", FALSE, 160, 0 },
    ...
    { PhDevicePropertyPkgModel, L"程序包: 模型", FALSE, 80, 0 },
    { PhDevicePropertyPkgVendorWebSite, L"程序包: 供应商网站", FALSE, 80, 0 },
    { PhDevicePropertyPkgDetailedDescription, L"程序包: 描述", FALSE, 80, 0 },
    { PhDevicePropertyPkgDocumentationLink, L"程序包: 文档", FALSE, 80, 0 },
    { PhDevicePropertyPkgIcon, L"程序包: 图标", FALSE, 80, 0 },
    { PhDevicePropertyPkgBrandingIcon, L"程序包: 品牌图标", FALSE, 80, 0 },

    { PhDevicePropertyClassUpperFilters, L"类: 上层过滤器", FALSE, 80, 0 },
    { PhDevicePropertyClassLowerFilters, L"类: 下层过滤器", FALSE, 80, 0 },
    { PhDevicePropertyClassSecurity, L"类: 安全描述符 (二进制)", FALSE, 80, 0 },
    { PhDevicePropertyClassSecuritySDS, L"类: 安全描述符", FALSE, 80, 0 },
    { PhDevicePropertyClassDevType, L"类: 类型", FALSE, 80, 0 },
    { PhDevicePropertyClassExclusive, L"类: 独占", FALSE, 80, 0 },
    { PhDevicePropertyClassCharacteristics, L"类: 特征", FALSE, 80, 0 },
    { PhDevicePropertyClassName, L"类: 设备名称", FALSE, 80, 0 },
    { PhDevicePropertyClassClassName, L"类名称", FALSE, 80, 0 },
    { PhDevicePropertyClassIcon, L"类: 图标", FALSE, 80, 0 },
    { PhDevicePropertyClassClassInstaller, L"类: 安装程序", FALSE, 80, 0 },
    { PhDevicePropertyClassPropPageProvider, L"类: 属性页提供程序", FALSE, 80, 0 },
    { PhDevicePropertyClassNoInstallClass, L"类: 无安装", FALSE, 80, 0 },
    { PhDevicePropertyClassNoDisplayClass, L"类: 无显示", FALSE, 80, 0 },
    { PhDevicePropertyClassSilentInstall, L"类: 静默安装", FALSE, 80, 0 },
    { PhDevicePropertyClassNoUseClass, L"类: 无用类", FALSE, 80, 0 },
    { PhDevicePropertyClassDefaultService, L"类: 默认服务", FALSE, 80, 0 },
    { PhDevicePropertyClassIconPath, L"类: 图标路径", FALSE, 80, 0 },
    { PhDevicePropertyClassDHPRebalanceOptOut, L"类: DHP 重新平衡选择退出", FALSE, 80, 0 },
    { PhDevicePropertyClassClassCoInstallers, L"类: 协同安装程序", FALSE, 80, 0 },

    { PhDevicePropertyInterfaceFriendlyName, L"接口: 显示名称", FALSE, 80, 0 },
    { PhDevicePropertyInterfaceEnabled, L"接口: 已启用", FALSE, 80, 0 },
    { PhDevicePropertyInterfaceClassGuid, L"接口: 类 GUID", FALSE, 80, 0 },
    { PhDevicePropertyInterfaceReferenceString, L"接口: 引用", FALSE, 80, 0 },
    { PhDevicePropertyInterfaceRestricted, L"接口: 限制", FALSE, 80, 0 },
    { PhDevicePropertyInterfaceUnrestrictedAppCapabilities, L"接口: 不受限制的应用程序功能", FALSE, 80, 0 },
    { PhDevicePropertyInterfaceSchematicName, L"接口: 原图名称", FALSE, 80, 0 },

    { PhDevicePropertyInterfaceClassDefaultInterface, L"接口: 类默认接口", FALSE, 80, 0 },
    { PhDevicePropertyInterfaceClassName, L"接口: 类名称", FALSE, 80, 0 },

    { PhDevicePropertyContainerAddress, L"容器: 地址", FALSE, 80, 0 },
    { PhDevicePropertyContainerDiscoveryMethod, L"容器: 发现方法", FALSE, 80, 0 },
    { PhDevicePropertyContainerIsEncrypted, L"容器: 已加密", FALSE, 80, 0 },
    { PhDevicePropertyContainerIsAuthenticated, L"容器: 已认证", FALSE, 80, 0 },
    { PhDevicePropertyContainerIsConnected, L"容器: 已连接", FALSE, 80, 0 },
    { PhDevicePropertyContainerIsPaired, L"容器: 已配对", FALSE, 80, 0 },
    { PhDevicePropertyContainerIcon, L"容器: 图标", FALSE, 80, 0 },
    { PhDevicePropertyContainerVersion, L"容器: 版本", FALSE, 80, 0 },
    { PhDevicePropertyContainerLastSeen, L"容器: 最后出现于", FALSE, 80, 0 },
    { PhDevicePropertyContainerLastConnected, L"容器: 最后连接于", FALSE, 80, 0 },
    { PhDevicePropertyContainerIsShowInDisconnectedState, L"容器: 显示为断开连接状态", FALSE, 80, 0 },
    { PhDevicePropertyContainerIsLocalMachine, L"容器: 本机", FALSE, 80, 0 },
    { PhDevicePropertyContainerMetadataPath, L"容器: 元数据路径", FALSE, 80, 0 },
    { PhDevicePropertyContainerIsMetadataSearchInProgress, L"容器: 正在进行元数据搜索", FALSE, 80, 0 },
    { PhDevicePropertyContainerIsMetadataChecksum, L"容器: 元数据校验和", FALSE, 80, 0 },
    { PhDevicePropertyContainerIsNotInterestingForDisplay, L"容器: 不用于显示", FALSE, 80, 0 },
    { PhDevicePropertyContainerLaunchDeviceStageOnDeviceConnect, L"容器: 连接时启动", FALSE, 80, 0 },
    { PhDevicePropertyContainerLaunchDeviceStageFromExplorer, L"容器: 从资源管理器启动", FALSE, 80, 0 },
    { PhDevicePropertyContainerBaselineExperienceId, L"容器: 基线体验 ID", FALSE, 80, 0 },
    { PhDevicePropertyContainerIsDeviceUniquelyIdentifiable, L"容器: 唯一标识符", FALSE, 80, 0 },
    { PhDevicePropertyContainerAssociationArray, L"容器: 关联", FALSE, 80, 0 },
    { PhDevicePropertyContainerDeviceDescription1, L"容器: 描述", FALSE, 80, 0 },
    { PhDevicePropertyContainerDeviceDescription2, L"容器: 描述其他", FALSE, 80, 0 },
    { PhDevicePropertyContainerHasProblem, L"容器: 出现问题", FALSE, 80, 0 },
    { PhDevicePropertyContainerIsSharedDevice, L"容器: 共享设备", FALSE, 80, 0 },
    { PhDevicePropertyContainerIsNetworkDevice, L"容器: 网络设备", FALSE, 80, 0 },
    { PhDevicePropertyContainerIsDefaultDevice, L"容器: 默认设备", FALSE, 80, 0 },
    { PhDevicePropertyContainerMetadataCabinet, L"容器: 元数据柜", FALSE, 80, 0 },
    { PhDevicePropertyContainerRequiresPairingElevation, L"容器: 需要配对提升", FALSE, 80, 0 },
    { PhDevicePropertyContainerExperienceId, L"容器: 体验 ID", FALSE, 80, 0 },
    { PhDevicePropertyContainerCategory, L"容器: 类别", FALSE, 80, 0 },
    { PhDevicePropertyContainerCategoryDescSingular, L"容器: 类别描述", FALSE, 80, 0 },
    { PhDevicePropertyContainerCategoryDescPlural, L"容器: 类别描述 (复数)", FALSE, 80, 0 },
    { PhDevicePropertyContainerCategoryIcon, L"容器: 类别图标", FALSE, 80, 0 },
    { PhDevicePropertyContainerCategoryGroupDesc, L"容器: 类别组描述", FALSE, 80, 0 },
    { PhDevicePropertyContainerCategoryGroupIcon, L"容器: 类别组图标", FALSE, 80, 0 },
    { PhDevicePropertyContainerPrimaryCategory, L"容器: 主类别", FALSE, 80, 0 },
    { PhDevicePropertyContainerUnpairUninstall, L"容器: 取消配对卸载", FALSE, 80, 0 },
    { PhDevicePropertyContainerRequiresUninstallElevation, L"容器: 需要提升卸载权限", FALSE, 80, 0 },
    { PhDevicePropertyContainerDeviceFunctionSubRank, L"容器: 功能子排名", FALSE, 80, 0 },
    { PhDevicePropertyContainerAlwaysShowDeviceAsConnected, L"容器: 始终显示为已连接状态", FALSE, 80, 0 },
    { PhDevicePropertyContainerConfigFlags, L"容器: 控制标志", FALSE, 80, 0 },
    { PhDevicePropertyContainerPrivilegedPackageFamilyNames, L"容器: 特权程序包家族名称", FALSE, 80, 0 },
    { PhDevicePropertyContainerCustomPrivilegedPackageFamilyNames, L"容器: 自定义特权程序包家族名称", FALSE, 80, 0 },
    { PhDevicePropertyContainerIsRebootRequired, L"容器: 需要重启", FALSE, 80, 0 },
    { PhDevicePropertyContainerFriendlyName, L"容器: 显示名称", FALSE, 80, 0 },
    { PhDevicePropertyContainerManufacturer, L"容器: 制造商", FALSE, 80, 0 },
    { PhDevicePropertyContainerModelName, L"容器: 模型名称", FALSE, 80, 0 },
    { PhDevicePropertyContainerModelNumber, L"容器: 模型编号", FALSE, 80, 0 },
    { PhDevicePropertyContainerInstallInProgress, L"容器: 安装进行中", FALSE, 80, 0 },

    { PhDevicePropertyObjectType, L"对象类型", FALSE, 80, 0 },

    { PhDevicePropertyPciDeviceType, L"PCI: 设备类型", FALSE, 80, 0 },
    { PhDevicePropertyPciCurrentSpeedAndMode, L"PCI: 当前速度和模式", FALSE, 80, 0 },
    { PhDevicePropertyPciBaseClass, L"PCI: 基类", FALSE, 80, 0 },
    { PhDevicePropertyPciSubClass, L"PCI: 子类", FALSE, 80, 0 },
    { PhDevicePropertyPciProgIf, L"PCI: 编程接口", FALSE, 80, 0 },
    { PhDevicePropertyPciCurrentPayloadSize, L"PCI: 当前载荷大小", FALSE, 80, 0 },
    { PhDevicePropertyPciMaxPayloadSize, L"PCI: 最大载荷大小", FALSE, 80, 0 },
    { PhDevicePropertyPciMaxReadRequestSize, L"PCI: 最大读取请求大小", FALSE, 80, 0 },
    { PhDevicePropertyPciCurrentLinkSpeed, L"PCI: 当前链路速度", FALSE, 80, 0 },
    { PhDevicePropertyPciCurrentLinkWidth, L"PCI: 当前链路宽度", FALSE, 80, 0 },
    { PhDevicePropertyPciMaxLinkSpeed, L"PCI: 最大链路速度", FALSE, 80, 0 },
    { PhDevicePropertyPciMaxLinkWidth, L"PCI: 最大链路宽度", FALSE, 80, 0 },
    { PhDevicePropertyPciExpressSpecVersion, L"PCI Express: 规范版本", FALSE, 80, 0 },
    { PhDevicePropertyPciInterruptSupport, L"PCI: 中断支持", FALSE, 80, 0 },
    { PhDevicePropertyPciInterruptMessageMaximum, L"PCI: 中断消息最大值", FALSE, 80, 0 },
    { PhDevicePropertyPciBarTypes, L"PCI: BAR 类型", FALSE, 80, 0 },
    { PhDevicePropertyPciSriovSupport, L"PCI: SR-IOV 支持", FALSE, 80, 0 },
    { PhDevicePropertyPciLabel_Id, L"PCI: 标签 ID", FALSE, 80, 0 },
    { PhDevicePropertyPciLabel_String, L"PCI: 标签字符串", FALSE, 80, 0 },
    { PhDevicePropertyPciSerialNumber, L"PCI: 序列号", FALSE, 80, 0 },

    { PhDevicePropertyPciExpressCapabilityControl, L"PCI Express: 功能控制", FALSE, 80, 0 },
    { PhDevicePropertyPciNativeExpressControl, L"PCI: 原生 Express 控件", FALSE, 80, 0 },
    { PhDevicePropertyPciSystemMsiSupport, L"PCI: 系统 MSI 支持", FALSE, 80, 0 },

    { PhDevicePropertyStoragePortable, L"存储: 便携式", FALSE, 80, 0 },
    { PhDevicePropertyStorageRemovableMedia, L"存储: 可移动介质", FALSE, 80, 0 },
    { PhDevicePropertyStorageSystemCritical, L"存储: 系统关键", FALSE, 80, 0 },
    { PhDevicePropertyStorageDiskNumber, L"存储: 磁盘编号", FALSE, 80, 0 },
    { PhDevicePropertyStoragePartitionNumber, L"存储: 磁盘分区编号", FALSE, 80, 0 },
    ...
    case MainTabPageInitializeSectionMenuItems:
        {
            ...
            PhInsertEMenuItem(menu, PhPluginCreateEMenuItem(PluginInstance, 0, 98, L"全部收起", NULL), ULONG_MAX);
            ...
            PhInsertEMenuItem(menu, PhCreateEMenuSeparator(), ULONG_MAX);
            PhInsertEMenuItem(menu, showDisconnectedDevices = PhPluginCreateEMenuItem(PluginInstance, 0, 102, L"显示已断开连接设备", NULL), ULONG_MAX);
            ...
            PhInsertEMenuItem(menu, showDisabledDeviceInterfaces = PhPluginCreateEMenuItem(PluginInstance, 0, 105, L"显示已禁用设备接口", NULL), ULONG_MAX);
            PhInsertEMenuItem(menu, sortChildDevices = PhPluginCreateEMenuItem(PluginInstance, 0, 106, L"显示子设备", NULL), ULONG_MAX);
            PhInsertEMenuItem(menu, sortRootDevices = PhPluginCreateEMenuItem(PluginInstance, 0, 107, L"显示根设备", NULL), ULONG_MAX);
            PhInsertEMenuItem(menu, highlightUpperFiltered = PhPluginCreateEMenuItem(PluginInstance, 0, 108, L"高亮显示上层筛选器", NULL), ULONG_MAX);
            PhInsertEMenuItem(menu, highlightLowerFiltered = PhPluginCreateEMenuItem(PluginInstance, 0, 109, L"高亮显示下层筛选器", NULL), ULONG_MAX);
